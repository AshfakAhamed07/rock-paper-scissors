...
function playGame() {
  ...
  if (humanScore > computerScore) {
    console.log(
      `🎉 You win the game! Final Score: ${humanScore} to ${computerScore}`,
    );
  } else if (computerScore > humanScore) {
    console.log(
      `😢 Computer wins the game. Final Score: ${computerScore} to ${humanScore}`,
    );
  } else {
    console.log(
      `👔 The entire game is a tie! Final Score: ${humanScore} to ${computerScore}`,
    );
  }
}
playGame();
